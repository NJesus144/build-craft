...
interface ManageMultipleItemDialogProps extends BaseDialogProps {
...
export const ManageMultipleItemDialog = ({
  ...
  const formContent = useMemo(() => {
    ...
    return config.map((field, index) => {
      ...
      const inputProps = {
        name: field.key,
        label: field.label,
        className: cn(isFullWidth && 'col-span-2', field.className),
  ...
  const onSubmit = (formData: any) => {
    ...
    if (isEditing) {
      //verificar se algum dado foi alterado antes de atualizar
